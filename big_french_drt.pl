...
%
macro(dr(0,dr(0,s,dl(0,np,s)),np), dr(0,dr(0,lit(s(S)),dl(0,lit(np(nom,B,C)),lit(s(S)))),lit(np(nom,B,C)))).
macro(dl(0,np,dl(0,dr(0,s,np),s)), dl(0,lit(np(A,B,C)),dl(0,dr(0,lit(s(D)),lit(np(A,B,C))),lit(s(D))))).
...
possessive_s_features_1p(s, X, [variable(X)|Xs], Xs, [appl(orateur,X)|R], R).
possessive_s_features_1p(p, X, [variable(X),variable(Y)|Xs], Xs, [bool(Y,=,?),bool(num(Y),>,1),appl(orateur,X),bool(X,atomic_sub,Y)|R], R).
...
auxiliary_verb_avoir(POS, _Rest0, lambda(P,lambda(X,lambda(E,merge(appl(appl(P,X),E),drs(EVs,Rest)))))) :-
	past_participle_semantics(POS, [], EVs, E, Rest).
auxiliary_verb_y_avoir(POS, _Rest0, lambda(P,lambda(Y,lambda(X,lambda(E,merge(appl(appl(appl(P,Y),X),E),drs(EVs,Rest))))))) :-
	past_participle_semantics(POS, [], EVs, E, Rest).
...
default_roles([pp(_),pp(_)], np, _, [agent,patient,theme]).
...
sequence_semantics([ETRE,en,train,DE|_INF0], être_en_train_de, I, K, dl(0,lit(np(_,_,_)),lit(s(_))), lambda(NP,lambda(E,appl(NP,lambda(X,merge(drs(EVs,Conds),merge(drs([event(F)],[bool(appl(temps,E),subseteq,appl(temps,F))]),appl(appl(INF,lambda(Prp,appl(Prp,X))),F)))))))) :-
...
default_semantics(Word, nam, dr(0,lit(np(_,_,_)),lit(np(_,_,_))), lambda(NP,lambda(P,appl(NP,lambda(X,presup(drs([],[appl(appl(nommé,Word),X)]),appl(P,X))))))).
default_semantics(Word, nam, dl(0,lit(np(_,_,_)),lit(np(_,_,_))), lambda(NP,lambda(P,appl(NP,lambda(X,presup(drs([],[appl(appl(nommé,Word),X)]),appl(P,X))))))).
default_semantics(Word, nam:INFO, lit(np(_,_,_)), lambda(P,presup(drs([variable(X)],[appl(appl(nommé,Word),X)|Rest0]),appl(P,X)))) :-
	add_lefff_info(INFO, X, Rest),
	add_info(Word, X, Rest0, Rest).
default_semantics(Word, nam:INFO, dr(0,lit(np(_,_,_)),lit(np(_,_,_))), lambda(NP,lambda(P,appl(NP,lambda(X,presup(drs([],[appl(appl(nommé,Word),X)|Rest0]),appl(P,X))))))) :-
	add_lefff_info(INFO, X, Rest),
	add_info(Word, X, Rest0, Rest).
default_semantics(Word, nam:INFO, dl(0,lit(np(_,_,_)),lit(np(_,_,_))), lambda(NP,lambda(P,appl(NP,lambda(X,presup(drs([],[appl(appl(nommé,Word),X)|Rest0]),appl(P,X))))))) :-
	add_lefff_info(INFO, X, Rest),
	add_info(Word, X, Rest0, Rest).
...
default_semantics(faire, ver:TIME, dr(_,dl(0,lit(cl_r),dl(0,lit(np(_,_,_)),lit(s(_)))),dl(0,lit(np(_,_,_)),lit(s(INF)))), lambda(INFV,lambda(_SE,lambda(NP,lambda(E,appl(NP,lambda(Y,merge(drs(Es,Tnse),drs([variable(X),event(L)],[bool(X,=,'context?')|Conds]))))))))) :-
	nonvar(INF),
	INF = inf(_),
	add_roles([agent-X,patient-Y,theme-L], se_faire, E, Conds, [drs_label(L,merge(drs([event(F)],[]),appl(appl(INFV,lambda(Prp,appl(Prp,X))),F)))]),
...
default_semantics(faire, ver:TIME, dr(_,dl(0,lit(cl_r),dl(0,lit(np(_,_,_)),lit(s(_)))),dr(0,dl(0,lit(np(_,_,_)),lit(s(INF))),dia(_,box(_,lit(np(_,_,_)))))), lambda(INFObj,lambda(_SE,lambda(NP,lambda(E,appl(NP,lambda(Y,merge(drs(Es,Tnse),drs([variable(X),event(L)],[bool(X,=,'context?')|Conds]))))))))) :-
	nonvar(INF),
	INF = inf(_),
	add_roles([agent-X,patient-Y,theme-L], se_faire, E, Conds, [drs_label(L,merge(drs([event(F)],[]),appl(appl(appl(INFObj,lambda(Prp,appl(Prp,Y))),lambda(PX,appl(PX,X))),F)))]),
	pos_time(ver:TIME, [], Es, E-Tnse).														
...
default_semantics(montrer, ver:TIME, dr(_,dl(0,lit(cl_r),dl(0,lit(np(_,_,_)),lit(s(_)))),dl(0,lit(n),lit(n))), lambda(ADJ,lambda(_SE,lambda(NP,lambda(E,appl(NP,lambda(Y,merge(merge(drs([],[drs_label(L,appl(appl(ADJ,lambda(_,drs([],[]))),Y))|Conds]),drs(Es,Tnse)),appl(appl(ADJ,lambda(_,drs([],[]))),Y))))))))) :-
	add_roles([agent-Y,theme-L], se_montrer, E, Conds, []),
	pos_time(ver:TIME, [], Es, E-Tnse).

default_semantics(avérer, ver:TIME, dr(_,dl(0,lit(cl_r),dl(0,lit(np(_,_,_)),lit(s(_)))),dl(0,lit(n),lit(n))), lambda(ADJ,lambda(_SE,lambda(NP,lambda(E,appl(NP,lambda(Y,merge(merge(drs([],[drs_label(L,appl(appl(ADJ,lambda(_,drs([],[]))),Y))|Conds]),drs(Es,Tnse)),appl(appl(ADJ,lambda(_,drs([],[]))),Y))))))))) :-
	add_roles([agent-Y,theme-L], s_avérer, E, Conds, []),
	pos_time(ver:TIME, [], Es, E-Tnse).

% = se considérer/trouver + ADJ
%
...
default_semantics(tenir, ver:TIME, dr(_,dl(0,lit(cl_r),dl(0,lit(np(_,_,_)),lit(s(_)))),dl(0,lit(n),lit(n))), lambda(ADJ,lambda(_SE,lambda(NP,lambda(E,appl(NP,lambda(Y,merge(drs([],[drs_label(L,appl(appl(ADJ,lambda(_,drs([],[]))),Y))|Conds]),drs(Es,Tnse))))))))) :-
	add_roles([agent-Y,theme-L], se_tenir, E, Conds, []),
	pos_time(ver:TIME, [], Es, E-Tnse).

default_semantics(rendre, ver:TIME, dr(_,dl(0,lit(cl_r),dl(0,lit(np(_,_,_)),lit(s(_)))),dl(0,lit(n),lit(n))), lambda(ADJ,lambda(_SE,lambda(NP,lambda(E,appl(NP,lambda(Y,merge(drs([],[drs_label(L,appl(appl(ADJ,lambda(_,drs([],[]))),Y))|Conds]),drs(Es,Tnse))))))))) :-
	add_roles([agent-Y,theme-L], se_rendre, E, Conds, []),
	pos_time(ver:TIME, [], Es, E-Tnse).

default_semantics(dire, ver:TIME, dr(_,dl(0,lit(cl_r),dl(0,lit(np(_,_,_)),lit(s(_)))),dl(0,lit(n),lit(n))), lambda(ADJ,lambda(_SE,lambda(NP,lambda(E,appl(NP,lambda(Y,merge(drs([],[drs_label(L,appl(appl(ADJ,lambda(_,drs([],[]))),Y))|Conds]),drs(Es,Tnse))))))))) :-
	add_roles([agent-Y,theme-L], se_dire, E, Conds, []),
	pos_time(ver:TIME, [], Es, E-Tnse).
...
default_semantics(présenter, ver:TIME, dr(_,dl(0,lit(cl_r),dl(0,lit(np(_,_,_)),lit(s(_)))),dl(0,lit(n),lit(n))), lambda(ADJ,lambda(_SE,lambda(NP,lambda(E,appl(NP,lambda(Y,merge(drs([],[drs_label(L,appl(appl(ADJ,lambda(_,drs([],[]))),Y))|Conds]),drs(Es,Tnse))))))))) :-
...
% path/travel verbs, part of the Itipy project
...
default_semantics(Word, ver:TIME, dr(_,dl(0,lit(cl_r),dl(_,lit(np(_,_,_)),lit(s(_)))),dl(_,lit(np(_,_,_)),lit(s(inf(Prep))))), lambda(INF, lambda(_Refl, lambda(NPS, lambda(E, appl(NPS,lambda(Y,drs(EVs,Conds)))))))) :-
    ...
    ;
        add_roles([SRole-Y,CLRole-Y,IRole-L], PW, E, Conds, [drs_label(L,merge(drs([event(F)],[]),appl(appl(INF,lambda(Q,appl(Q,Y))),F)))|Pred])
    ),
...
default_semantics(avoir, POS, dr(_,dl(_,lit(cl_y),dl(_,lit(np(_,_,_)),lit(s(_)))),dl(_,lit(cl_y),dl(_,lit(np(_,_,_)),lit(s(ppart))))), Sem) :-
	auxiliary_verb_y_avoir(POS, [], Sem).
...
default_semantics(avoir, POS, dr(0,dl(0,lit(cl_y),dl(0,lit(np(_,_,_)),lit(s(_)))),lit(np(_,_,_))), lambda(NP,lambda(_Y,lambda(_IL,lambda(E,appl(NP,lambda(X,drs(Vars,Conds)))))))) :-
...
default_semantics(Word, ver:TIME, dr(0,dr(0,dl(_,lit(np(_,_,_)),lit(s(_))),lit(pp(Prep))),lit(np(acc,_,_))), lambda(OBJ,lambda(PP,lambda(SUJ,lambda(E,appl(SUJ,lambda(X,appl(OBJ,lambda(Y,appl(PP,lambda(Z,drs(EVs,L0)))))))))))) :-
	...
	pos_time(ver:TIME, [], EVs, E-Time).
default_semantics(Word, ver:TIME, dr(0,dr(0,dl(_,lit(np(_,_,_)),lit(s(_))),lit(pp(Prep1))),lit(pp(Prep2))), lambda(PP2,lambda(PP,lambda(SUJ,lambda(E,appl(SUJ,lambda(X,appl(PP2,lambda(Y,appl(PP,lambda(Z,drs(EVs,L0)))))))))))) :-
        combine_prep_word(Prep2, Word, PW1),
        combine_prep_word(Prep1, PW1, PW),
	get_roles(Word, [np,pp(Prep2),pp(Prep1)], [SRole,PRole2,PRole1]),
	add_roles([SRole-X,PRole2-Y,PRole1-Z], PW, E, L0, Time),
	pos_time(ver:TIME, [], EVs, E-Time).
...
default_semantics(venir, ver:TIME, dr(_,dl(_,lit(np(_,_,_)),lit(s(_))),dl(_,lit(np(_,_,_)),lit(s(inf(de))))), lambda(P,lambda(X,lambda(E,merge(drs(Events,Pred),appl(appl(P,X),E)))))) :-
     ...
     ->
        Events0 = [event(S1)],
        Pred0 = [bool(appl(temps,E),<,S1),bool(S1,=,'event?'),bool(S1,<,maintenant)]
      ;
        Events0 = [],
        Pred0 = [bool(appl(temps,E),<,maintenant)]
      ),
	...
	(
     ...
     ->
      ...
      ;
        TIME = impf
     ->
        DRS = drs([event(S1)],[bool(S1,=,'event?'),bool(appl(temps,S1),<,maintenant),bool(appl(temps,E),>,appl(temps,S1))])
      ;
        DRS = drs([],[])
      ).
...
default_semantics(conduire, ver:TIME, dr(_,dl(_,lit(np(_,_,_)),lit(s(_))),dl(_,lit(np(_,_,_)),lit(s(inf(à))))), lambda(INF, lambda(NP, lambda(E, appl(NP,lambda(X,drs(EVs,Conds))))))) :-
...
default_semantics(laisser, ver:TIME, dr(_,dl(_,lit(np(_,_,_)),lit(s(_))),dl(_,lit(np(_,_,_)),lit(s(inf(à))))), lambda(INF, lambda(NP, lambda(E, appl(NP,lambda(X,drs(EVs,[appl(event,E),appl(laisser,E),appl(appl(agent,X),E),appl(appl(theme,L),E),drs_label(L,merge(drs([variable(Y),event(F)],[appl(generic,Y)]),appl(appl(INF,lambda(P,appl(P,Y))),F))),bool(appl(temps,E),subseteq,appl(temps,L))|Pred]))))))) :-
	pos_time(ver:TIME, [event(L)], EVs, E-Pred).
default_semantics(obliger, ver:TIME, dr(_,dl(_,lit(np(_,_,_)),lit(s(_))),dl(_,lit(np(_,_,_)),lit(s(inf(à))))), lambda(INF, lambda(NP, lambda(E, appl(NP,lambda(X,drs(EVs,[appl(event,E),appl(obliger,E),appl(appl(agent,X),E),appl(appl(theme,L),E),drs_label(L,merge(drs([variable(Y),event(F)],[appl(generic,Y)]),appl(appl(INF,lambda(P,appl(P,Y))),F)))|Pred]))))))) :-
	pos_time(ver:TIME, [event(L)], EVs, E-Pred).
...
% = entendre + inf (existential object)
default_semantics(entendre, POS, dr(0,dl(0,lit(np(_,_,_)),lit(s(_))),dl(0,lit(np(_,_,_)),lit(s(SType)))), lambda(DEINF, lambda(NPS, lambda(E, appl(NPS,lambda(X,drs(EVs,Conds))))))) :-
	SType = inf(_),
	add_roles([agent-X,patient-Y,theme-L], entendre, E, Conds, [drs_label(L,merge(drs([event(F)],[]),appl(appl(DEINF,lambda(Prp,appl(Prp,Y))),F)))|Pred]),
	pos_time(POS, [event(L),variable(Y)], EVs, E-Pred).
% = voir + inf (existential object)
default_semantics(voir, POS, dr(0,dl(0,lit(np(_,_,_)),lit(s(_))),dl(0,lit(np(_,_,_)),lit(s(SType)))), lambda(DEINF, lambda(NPS, lambda(E, appl(NPS,lambda(X,drs(EVs,Conds))))))) :-
	SType = inf(_),
	add_roles([agent-X,patient-Y,theme-L], voir, E, Conds, [drs_label(L,merge(drs([event(F)],[]),appl(appl(DEINF,lambda(Prp,appl(Prp,Y))),F)))|Pred]),
	pos_time(POS, [event(L),variable(Y)], EVs, E-Pred).
...
default_semantics(valoir, ver:TIME, dr(_,dl(_,lit(np(_,_,_)),lit(s(_))),dl(_,lit(np(_,_,_)),lit(s(SType)))), lambda(INF, lambda(_NP, lambda(E, drs(EVs,Conds))))) :-
	SType = inf(_),
...
default_semantics(savoir, POS, dr(_,dl(_,lit(np(_,_,_)),lit(s(_))),dl(_,lit(np(_,_,_)),lit(s(inf(_))))), Sem) :-
	sem_tv_subject_control(savoir, POS, Sem).
...
default_semantics(pousser, POS, dr(0,dr(0,dl(0,lit(np(_,_,_)),lit(s(_))),dl(0,lit(np(_,_,_)),lit(s(inf(à))))),lit(np(_,_,_))), lambda(NPO, lambda(DEINF, lambda(NPS, lambda(E, appl(NPO,lambda(Y,appl(NPS,lambda(X,drs(EVs,Conds)))))))))) :-
	add_roles([agent-X,patient-Y,theme-L], pousser_à, E, Conds, [drs_label(L,merge(drs([event(F)],[]),appl(appl(DEINF,lambda(Prp,appl(Prp,Y))),F)))|Pred]),
	pos_time(POS, [event(L)], EVs, E-Pred).

% = pousser + ainf (generic object)
default_semantics(pousser, POS, dr(0,dl(0,lit(np(_,_,_)),lit(s(_))),dl(0,lit(np(_,_,_)),lit(s(SType)))), lambda(DEINF, lambda(NPS, lambda(E, appl(NPS,lambda(X,drs(EVs,[appl(generic,Y)|Conds]))))))) :-
	SType = inf(_),
	add_roles([agent-X,patient-Y,theme-L], pousser_à, E, Conds, [drs_label(L,merge(drs([event(F)],[]),appl(appl(DEINF,lambda(Prp,appl(Prp,Y))),F)))|Pred]),
...
default_semantics(permettre, POS, dr(0,dl(0,lit(np(_,_,_)),lit(s(_))),dl(0,lit(np(_,_,_)),lit(s(SType)))), lambda(DEINF, lambda(NPS, lambda(E, appl(NPS,lambda(X,drs(EVs,[appl(generic,Y)|Conds]))))))) :-
	SType = inf(_),
...
default_semantics(voir, ver:TIME, dr(0,dr(_,dl(_,lit(np(_,_,_)),lit(s(_))),dl(_,lit(np(_,_,_)),lit(s(SType)))),lit(np(_,_,_))), lambda(NPO, lambda(INF, lambda(NPS, lambda(E, appl(NPS,lambda(Y,appl(NPO,lambda(X,drs(EVs,Conds)))))))))) :-
	...
	add_roles([agent-Y,patient-X,theme-L], PW, E, Conds, [drs_label(L,merge(drs([event(F)],[bool(appl(temps,E),subseteq,appl(temps,F))]),appl(appl(INF,lambda(P,appl(P,X))),F)))|Pred]),
	pos_time(ver:TIME, [event(L)], EVs, E-Pred).
default_semantics(voir, ver:TIME, dr(0,dr(_,dl(_,lit(np(_,_,_)),lit(s(_))),lit(np(_,_,_))),dl(_,lit(np(_,_,_)),lit(s(SType)))), lambda(INF, lambda(NPO, lambda(NPS, lambda(E, appl(NPS,lambda(Y,appl(NPO,lambda(X,drs(EVs,Conds)))))))))) :-
	SType = inf(Prep),
	combine_prep_word(Prep, voir, PW),
	add_roles([agent-Y,patient-X,theme-L], PW, E, Conds, [drs_label(L,merge(drs([event(F)],[bool(appl(temps,E),subseteq,appl(temps,F))]),appl(appl(INF,lambda(P,appl(P,Y))),F)))|Pred]),
	pos_time(ver:TIME, [event(L)], EVs, E-Pred).
...
default_semantics(Word, ver:TIME, dl(1,lit(s(_)),dl(_,lit(np(_,_,_)),lit(s(_)))), lambda(SQ,lambda(NP,lambda(E,appl(NP,lambda(X,drs(EVs,Conds))))))) :-
	add_roles([agent-X,theme-L], Word, E, Conds, [drs_label(L,merge(drs([event(F)],[]),appl(SQ,F)))|List]),		
	pos_time(ver:TIME, [event(L)], EVs, E-List).
...
% ensemble
%
% uses simple, subject oriented interpretation

default_semantics(ensemble, adv, dl(_, dl(_,lit(np(_,_,_)),lit(s(_))),  dl(_,lit(np(_,_,_)),lit(s(_)))), lambda(VP,lambda(NP,lambda(E,appl(NP,lambda(X,merge(appl(appl(VP,lambda(P,appl(P,X))),E),drs([],[appl(appl(ensemble,X),E)])))))))).



default_semantics(W, adv, dr(_,dr(_,lit(np(N1,N2,N3)),lit(s(ST))),dl(_,lit(np(N1,N2,N3)),lit(s(ST)))), lambda(VP, lambda(NP, lambda(E, merge(drs([],[appl(W,E)]),appl(appl(VP,NP),E)))))).
...
default_semantics(lequel, pro:rel, dr(0,lit(s(whq)),dl(0,lit(np(_,_,_)),lit(s(_)))), lambda(VP,lambda(E,merge(drs([variable(X)],[appl('quel?',X)]),appl(appl(VP,lambda(P,appl(P,X))),E))))).

default_semantics(quel, pro:rel, dr(0,dr(0,lit(s(whq)),dl(0,lit(np(_,_,_)),lit(s(_)))),lit(n)), lambda(N, lambda(VP,lambda(E,merge(merge(drs([variable(X)],[appl('quel?',X)]),appl(N,X)),appl(appl(VP,lambda(P,appl(P,X))),E)))))). 

default_semantics(qui, pro:rel, dr(0,dl(0,dr(0,lit(pp(_)),lit(np(_,_,_))),dl(0,lit(np(_,_,_)),lit(np(_,_,_)))),dr(0,lit(s(_)),dia(1,box(1,lit(pp(_)))))), lambda(VP,lambda(_,lambda(NP,lambda(P,appl(NP,lambda(X,merge(merge(drs([event(E)],[]),appl(appl(VP,lambda(Q,appl(Q,X))),E)),appl(P,X))))))))).
...
default_semantics(tandis, dr(0,dr(0,lit(s(Z)),lit(s(Z))),lit(s(q))), lambda(P,lambda(Q,lambda(F,merge(drs([event(E)],[bool(drs([],[appl(appl(contrast,F),E)]),\/,drs([],[appl(appl(background,F),E)]))]),merge(appl(P,E),appl(Q,F))))))).
...
default_semantics(à, dr(0, dr(0, dl(1, dl(0, lit(n), lit(n)), dl(0, lit(n), lit(n))), lit(np(_,_,_))), lit(n)), lambda(_, lambda(NP, lambda(Adj, lambda(N,lambda(X,appl(NP,lambda(Y,merge(drs([],[appl(appl(à_travers,X),Y)]),merge(appl(appl(Adj,N),X),appl(N,X))))))))))).
...
default_semantics('maître', dr(_,lit(np(_,_,_)),lit(np(_,_,_))), Sem) :-
	title_semantics('maître', Sem).
default_semantics('Maître', dr(_,lit(np(_,_,_)),lit(np(_,_,_))), Sem) :-
	title_semantics('maître', Sem).
default_semantics('Me', dr(_,lit(np(_,_,_)),lit(np(_,_,_))), Sem) :-
	title_semantics('maître', Sem).
default_semantics('Me.', dr(_,lit(np(_,_,_)),lit(np(_,_,_))), Sem) :-
	title_semantics('maître', Sem).
...
% = special case for prepositions like "à" in contexts like "rien à voir" 

default_semantics(Word, dr(_,dl(_,lit(np(_,_,_)),lit(np(_,_,_))),dr(_,dl(_,lit(np(_,_,_)),lit(s(inf(_)))),dia(1,box(1,lit(np(_,_,_)))))), lambda(TV,lambda(NP,lambda(P,merge(drs([variable(X),event(E),event(F)],[appl(appl(Word,F),X),appl(generic,X),drs_label(F,appl(NP,lambda(Y,appl(appl(appl(TV,lambda(Q,appl(Q,Y))),lambda(R,appl(R,X))),E))))]),appl(P,X)))))).
...
lex(non, dr(0,dl(0,n,n),dl(0,n,n)), lambda(ADJ,lambda(N,lambda(X,merge(drs([],[not(appl(appl(ADJ,lambda(_,drs([],[]))),X))]),appl(N,X)))))).
lex(non, dr(0,dr(0,n,n),dr(0,n,n)), lambda(ADJ,lambda(N,lambda(X,merge(drs([],[not(appl(appl(ADJ,lambda(_,drs([],[]))),X))]),appl(N,X)))))).
lex(non, dl(1,dl(0,n,n),dl(0,n,n)), lambda(ADJ,lambda(N,lambda(X,merge(drs([],[not(appl(appl(ADJ,lambda(_,drs([],[]))),X))]),appl(N,X)))))).
lex('non-', dr(0,dl(0,n,n),dl(0,n,n)), lambda(ADJ,lambda(N,lambda(X,merge(drs([],[not(appl(appl(ADJ,lambda(_,drs([],[]))),X))]),appl(N,X)))))).
...
lex(non, dr(0,dr(0,s,s),dr(0,s,s)), lambda(SMOD,lambda(S,lambda(E,merge(appl(S,E),drs([],not(appl(appl(SMOD,lambda(_,[])),E)))))))).
...
% -ci and -là do nothing at the moment, could be made more sophisticated
% -ci (here) is closer to the speaker and -là (there) farther

lex('-ci', dl(0,np,np), lambda(X,X)). 
lex('-là', dl(0,np,np), lambda(X,X)).  
...
lex(aussi, dr(0,dr(0,dl(0,lit(n),lit(n)),lit(s(q))),dl(0,lit(n),lit(n))), lambda(Adj,lambda(SQ,lambda(P,lambda(X,drs([event(L1),event(L2),event(E1)],[drs_label(L1,appl(SQ,E1)),drs_label(L2,appl(appl(Adj,P),X)),bool(appl(mésure,L2),=,appl(mésure,L1))])))))).
...
lex(plus, dr(0,dr(0,n,s_q),n), lambda(N,lambda(Q,lambda(X,merge(drs([event(E),event(L1),event(L2)],[drs_label(L1,appl(Q,E)),drs_label(L2,appl(N,X))]),appl(N,X)))))).


lex(aussi, dr(0,dr(0,dl(1,s,s),s_q),dl(1,s,s)), lambda(SS,lambda(SQ,lambda(S,lambda(E,merge(appl(S,E),drs([event(L),event(M),event(F),event(G)],[drs_label(L,appl(appl(SS,S),F)),drs_label(M,appl(SQ,G)),bool(appl(mésure,L),=,appl(mésure,M))]))))))).

%lex(toujours, dl(1,s,s), lambda(S,lambda(E,drs([],drs([event(X)],[

lex(que, dr(0,lit(s(q)),lit(np(_,_,_))), lambda(NP,lambda(E,appl(NP,lambda(X,drs([variable(Y)],[bool(X,is_at(E),Y)])))))).
lex('qu\'', dr(0,lit(s(q)),lit(np(_,_,_))), lambda(NP,lambda(E,appl(NP,lambda(X,drs([variable(Y)],[bool(X,is_at(E),Y)])))))).
lex(que, dr(0,lit(s(q)),lit(pp(_))), lambda(NP,lambda(E,appl(NP,lambda(X,drs([variable(Y)],[bool(X,is_at(E),Y)])))))).
lex('qu\'', dr(0,lit(s(q)),lit(pp(_))), lambda(NP,lambda(E,appl(NP,lambda(X,drs([variable(Y)],[bool(X,is_at(E),Y)])))))).
...
lex('En', dr(0,dr(0,dr(0,s,dl(0,np,s)),np),dl(0,np,s_ppres)), lambda(VPD,lambda(NP,lambda(VP,lambda(E,appl(NP,lambda(X,merge(appl(appl(VP,lambda(P,appl(P,X))),E),merge(drs([event(F)],[bool(appl(temps,E),subseteq,appl(temps,F))]),appl(appl(VPD,lambda(Q,appl(Q,X))),F)))))))))).
lex(en, dr(0,dr(0,dr(0,s,dl(0,np,s)),np),dl(0,np,s_ppres)), lambda(VPD,lambda(NP,lambda(VP,lambda(E,appl(NP,lambda(X,merge(appl(appl(VP,lambda(P,appl(P,X))),E),merge(drs([event(F)],[bool(appl(temps,E),subseteq,appl(temps,F))]),appl(appl(VPD,lambda(Q,appl(Q,X))),F)))))))))).
...
lex('Pour', dr(0,dr(0,s,s),dl(0,lit(np(_,_,_)),s_inf)), lambda(VP,lambda(S,lambda(E,merge(appl(appl(VP,lambda(P,appl(P,X))),F),merge(appl(S,E),drs([variable(X),event(F)],[appl(appl(goal,F),E),bool(X,=,appl(agent,E))]))))))).
...
lex(pour, dr(0,dr(0,s,s),dl(0,lit(np(_,_,_)),s_inf)), lambda(VP,lambda(S,lambda(E,merge(appl(appl(VP,lambda(P,appl(P,X))),F),merge(appl(S,E),drs([variable(X),event(F)],[appl(appl(goal,F),E),bool(X,=,appl(agent,E))]))))))).
lex(pour, dr(0,dl(1,s,s),dl(0,lit(np(_,_,_)),s_inf)), lambda(VP,lambda(S,lambda(E,merge(appl(appl(VP,lambda(P,appl(P,X))),F),merge(appl(S,E),drs([variable(X),event(F)],[appl(appl(goal,F),E),bool(X,=,appl(agent,E))]))))))).
lex(pour, dr(0,dr(0,dl(0,np,s),dl(0,np,s)),dl(0,np,s_inf)), lambda(VPInf,lambda(VP,lambda(NP,lambda(E,appl(NP,lambda(X,merge(appl(appl(VP,lambda(P,appl(P,X))),E),merge(merge(drs([event(F)],[]),appl(appl(VPInf,lambda(Q,appl(Q,X))),F)),drs([],[appl(appl(goal,F),E)])))))))))).
lex(pour, dr(0,dr(0,dr(0,s,dl(0,np,s)),np),dl(0,np,s_inf)), lambda(VPInf,lambda(NP,lambda(VP,lambda(E,appl(NP,lambda(X,merge(appl(appl(VP,lambda(P,appl(P,X))),E),merge(merge(drs([event(F)],[]),appl(appl(VPInf,lambda(Q,appl(Q,X))),F)),drs([],[appl(appl(goal,F),E)])))))))))).
...
lex('Sans', dr(0,dr(0,s,s),dl(0,lit(np(_,_,_)),s_inf)), lambda(VP,lambda(S,lambda(E,merge(merge(appl(S,E),drs([variable(X),event(F)],[bool(X,=,'?'),bool(appl(temps,E),subseteq,appl(temps,F))])),drs([],[appl(appl(VP,lambda(P,not(appl(P,X)))),F)])))))).
lex('Sans', dr(0,dl(1,s,s),dl(0,lit(np(_,_,_)),s_inf)), lambda(VP,lambda(S,lambda(E,merge(merge(appl(S,E),drs([variable(X),event(F)],[bool(X,=,'?'),bool(appl(temps,E),subseteq,appl(temps,F))])),drs([],[appl(appl(VP,lambda(P,not(appl(P,X)))),F)])))))).
lex(sans, dr(0,dr(0,s,s),dl(0,lit(np(_,_,_)),s_inf)), lambda(VP,lambda(S,lambda(E,merge(merge(appl(S,E),drs([variable(X),event(F)],[bool(X,=,'?'),bool(appl(temps,E),subseteq,appl(temps,F))])),drs([],[appl(appl(VP,lambda(P,not(appl(P,X)))),F)])))))).
lex(sans, dr(0,dl(1,s,s),dl(0,lit(np(_,_,_)),s_inf)), lambda(VP,lambda(S,lambda(E,merge(merge(appl(S,E),drs([variable(X),event(F)],[bool(X,=,'?'),bool(appl(temps,E),subseteq,appl(temps,F))])),drs([],[appl(appl(VP,lambda(P,not(appl(P,X)))),F)])))))).
lex(sans, dr(0,dl(0,dl(0,np,s),dl(0,np,s)),dl(0,np,s_inf)), lambda(VPInf,lambda(VP,lambda(NP,lambda(E,appl(NP,lambda(X,merge(appl(appl(VP,lambda(P,appl(P,X))),E),drs([event(F)],[bool(appl(temps,E),subseteq,appl(temps,F)),not(appl(appl(VPInf,lambda(Q,appl(Q,X))),F))]))))))))).
lex(sans, dr(0,dl(1,dl(0,np,s),dl(0,np,s)),dl(0,np,s_inf)), lambda(VPInf,lambda(VP,lambda(NP,lambda(E,appl(NP,lambda(X,merge(appl(appl(VP,lambda(P,appl(P,X))),E),drs([event(F)],[bool(appl(temps,E),subseteq,appl(temps,F)),not(appl(appl(VPInf,lambda(Q,appl(Q,X))),F))]))))))))).
lex(sans, dr(0,dl(0,np,np),dl(0,np,s_inf)), lambda(VPInf, lambda(NP,lambda(P,appl(NP,lambda(X,merge(appl(P,X),drs([event(E),variable(Y)],[appl(generic,Y),not(appl(appl(VPInf,lambda(Q,appl(Q,Y))),E))])))))))).

lex('Faute', dr(0,dr(0,s,s),dl(0,lit(np(_,_,_)),s_deinf)), lambda(VP,lambda(S,lambda(E,merge(appl(S,E),merge(drs([variable(X),event(F)],[appl(appl(faute_de,E),F),appl(appl(explanation,E),F),bool(X,=,'context?')]),drs([],[not(appl(appl(VP,lambda(P,appl(P,X))),F))]))))))).
lex(faute, dr(0,dl(1,s,s),dl(0,lit(np(_,_,_)),s_deinf)), lambda(VP,lambda(S,lambda(E,merge(appl(S,E),merge(drs([variable(X),event(F)],[appl(appl(faute_de,E),F),appl(appl(explanation,E),F),bool(X,=,'context?')]),drs([],[not(appl(appl(VP,lambda(P,appl(P,X))),F))]))))))).

lex('Quitte', dr(0,dr(0,s,s),dl(0,lit(np(_,_,_)),s_ainf)), lambda(VP,lambda(S,lambda(E,merge(merge(drs([event(F)],[]),appl(appl(VP,lambda(P,appl(P,X))),F)),merge(appl(S,E),drs([variable(X),event(F)],[appl(appl(quitte_à,F),E),bool(X,=,'context?')]))))))).
lex(quitte, dr(0,dl(1,s,s),dl(0,lit(np(_,_,_)),s_ainf)), lambda(VP,lambda(S,lambda(E,merge(merge(drs([event(F)],[]),appl(appl(VP,lambda(P,appl(P,X))),F)),merge(appl(S,E),drs([variable(X),event(F)],[appl(appl(quitte_à,F),E),bool(X,=,'context?')]))))))).

lex('Jusqu\'', dr(0,dr(0,s,s),dl(0,lit(np(_,_,_)),s_ainf)), lambda(VP,lambda(S,lambda(E,merge(merge(drs([event(F)],[]),appl(appl(VP,lambda(P,appl(P,X))),F)),merge(appl(S,E),drs([variable(X),event(F)],[appl(appl(jusque_à,F),E),appl(appl(result,F),E),bool(X,=,'context?')]))))))).
lex('jusqu\'', dr(0,dl(1,s,s),dl(0,lit(np(_,_,_)),s_ainf)), lambda(VP,lambda(S,lambda(E,merge(merge(drs([event(F)],[]),appl(appl(VP,lambda(P,appl(P,X))),F)),merge(appl(S,E),drs([variable(X),event(F)],[appl(appl(jusqu_à,F),E),appl(appl(result,F),E),bool(X,=,'context?')]))))))).


lex('Avant', dr(0,dr(0,s,s),dl(0,lit(np(_,_,_)),s_deinf)), lambda(VP,lambda(S,lambda(E,merge(appl(appl(VP,lambda(P,appl(P,X))),F),merge(appl(S,E),drs([variable(X),event(F)],[bool(appl(temps,E),'<',appl(temps,F)),bool(X,=,'context?')]))))))).
lex('Avant', dr(0,dl(1,s,s),dl(0,lit(np(_,_,_)),s_deinf)), lambda(VP,lambda(S,lambda(E,merge(appl(appl(VP,lambda(P,appl(P,X))),F),merge(appl(S,E),drs([variable(X),event(F)],[bool(appl(temps,E),'<',appl(temps,F)),bool(X,=,appl(agent,E))]))))))).
lex(avant, dr(0,dr(0,s,s),dl(0,lit(np(_,_,_)),s_deinf)), lambda(VP,lambda(S,lambda(E,merge(appl(appl(VP,lambda(P,appl(P,X))),F),merge(appl(S,E),drs([variable(X),event(F)],[bool(appl(temps,E),'<',appl(temps,F)),bool(X,=,'context?')]))))))).
lex(avant, dr(0,dl(1,s,s),dl(0,lit(np(_,_,_)),s_deinf)), lambda(VP,lambda(S,lambda(E,merge(appl(appl(VP,lambda(P,appl(P,X))),F),merge(appl(S,E),drs([variable(X),event(F)],[bool(appl(temps,E),'<',appl(temps,F)),bool(X,=,'context?')]))))))).
lex('Avant', dr(0,dr(0,s,s),dl(0,lit(np(_,_,_)),s_inf)), lambda(VP,lambda(S,lambda(E,merge(appl(appl(VP,lambda(P,appl(P,X))),F),merge(appl(S,E),drs([variable(X),event(F)],[bool(appl(temps,E),'<',appl(temps,F)),bool(X,=,'context?')]))))))).
...
lex('Afin', dr(0,dr(0,s,s),dl(0,lit(np(_,_,_)),s_deinf)), lambda(VP,lambda(S,lambda(E,merge(appl(appl(VP,lambda(P,appl(P,X))),F),merge(appl(S,E),drs([variable(X),event(F)],[appl(appl(goal,F),E),bool(X,=,appl(agent,E))]))))))).
...
lex(aussi, dl(1,s,s), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),appl(appl(parallel,E),F)]),appl(S,E))))).
lex('aussitôt', dl(1,s,s), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),bool(drs([],[appl(appl(narration,E),F)]),\/,drs([],[appl(appl(result,E),F)])),bool(appl(temps,F),abuts,appl(temps,E))]),appl(S,E))))).
...
lex(jamais, dr(0,s,s), lambda(S, lambda(F, drs([], [not(merge(drs([event(E)],[bool(appl(temps,E),subseteq,appl(temps,F))]),appl(S,E)))])))).
lex(jamais, dl(1,s,s), lambda(S, lambda(F, drs([], [not(merge(drs([event(E)],[bool(appl(temps,E),subseteq,appl(temps,F))]),appl(S,E)))])))).
%lex(jamais, dr(0,np,np), lambda(NP, lambda(P, appl(NP, lambda(X, merge(
...
lex(ce, dr(0,lit(np(_,_,_)),lit(n)), Sem) :-
	gq_this_semantics(Sem).
lex(cet, dr(0,lit(np(_,_,_)),lit(n)), Sem) :-
	gq_this_semantics(Sem).
lex(cette, dr(0,lit(np(_,_,_)),lit(n)), Sem) :-
	gq_this_semantics(Sem).
lex('Ce', dr(0,lit(np(_,_,_)),lit(n)), Sem) :-
	gq_this_semantics(Sem).
...
lex(le, dr(0,dr(0,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
lex(le, dr(0,dl(1,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
lex('Le', dr(0,dr(0,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
lex('Le', dr(0,dl(1,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
lex(la, dr(0,dr(0,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
lex(la, dr(0,dl(1,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
lex('La', dr(0,dr(0,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
lex('La', dr(0,dl(1,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
lex('l\'', dr(0,dr(0,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
lex('l\'', dr(0,dl(1,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
lex('L\'', dr(0,dr(0,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
lex('L\'', dr(0,dl(1,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
% "ce matin", etc.
% these may be better treated as a anaphoric, though there is not always a clear referent (there is a default to "today"/"the current year", etc.)
lex(ce, dr(0,dr(0,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
lex(ce, dr(0,dl(1,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
lex('Ce', dr(0,dr(0,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
lex('Ce', dr(0,dl(1,lit(s(_)),lit(s(_))),lit(n)), lambda(N, lambda(S, lambda(E, merge(merge(drs([variable(X)],[bool(E,subseteq,X)]),appl(N,X)),appl(S,E)))))).
...
% au moins X/au plus X

lex('Au', dr(0,dr(0,np,np),n), lambda(N,lambda(NP,lambda(P,appl(NP,lambda(X,merge(merge(drs([],[appl(au,X)]),appl(N,X)),appl(P,X)))))))).
lex(au, dr(0,dr(0,np,np),n), lambda(N,lambda(NP,lambda(P,appl(NP,lambda(X,merge(merge(drs([],[appl(au,X)]),appl(N,X)),appl(P,X)))))))).
...
lex('Un', dr(0,dr(0,np,np),n), lambda(N,lambda(NP,lambda(P,appl(NP,lambda(X,merge(merge(drs([],[appl(un,X)]),appl(N,X)),appl(P,X)))))))).
lex(un, dr(0,dr(0,np,np),n), lambda(N,lambda(NP,lambda(P,appl(NP,lambda(X,merge(merge(drs([],[appl(un,X)]),appl(N,X)),appl(P,X)))))))).

% deux fois

lex('Deux', dr(0,dr(0,np,np),n), lambda(N,lambda(NP,lambda(P,appl(NP,lambda(X,merge(merge(drs([],[appl(deux,X)]),appl(N,X)),appl(P,X)))))))).
lex(deux, dr(0,dr(0,np,np),n), lambda(N,lambda(NP,lambda(P,appl(NP,lambda(X,merge(merge(drs([],[appl(deux,X)]),appl(N,X)),appl(P,X)))))))).
...
lex(et, dr(0,dl(0,dr(0,dl(0,n,n),np),dr(0,dl(0,n,n),np)),dr(0,dl(0,n,n),np)), lambda(N, lambda(M, lambda(NP, lambda(NN, lambda(X,appl(NP,lambda(Y,merge(merge(
	appl(appl(appl(M,lambda(P,appl(P,Y))),lambda(_,drs([],[]))),X),
	appl(appl(appl(N,lambda(Q,appl(Q,Y))),lambda(_,drs([],[]))),X)),appl(NN,X)))))))))).																	     
...
lex(et, dr(0,dl(0,dl(0,np,np),dl(0,np,np)),dl(0,n,n)), lambda(M, lambda(N, lambda(NP, lambda(P, appl(NP, lambda(X,  merge(appl(appl(N,lambda(Q,appl(Q,X))),lambda(_,drs([],[]))),merge(appl(appl(M,lambda(_,drs([],[]))),X), appl(P,X)))))))))).


lex(et, dr(0,dl(0,lit(s(Z)),lit(s(Z))),lit(s(_))), lambda(P,lambda(Q,lambda(F,merge(drs([event(E)],[appl(appl(narration,F),E)]),merge(appl(P,E),appl(Q,F))))))).
...
lex('Et', dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[appl(appl(parallel,F),E),bool(F,=,?)]), appl(S,E))))).
lex(et, dr(0,dr(0,s,s),dr(0,s,s)), lambda(SS,lambda(S,lambda(E,merge(drs([event(F)],[appl(appl(parallel,F),E),bool(F,=,'event?')]),merge(appl(S,E),appl(appl(SS,S),E))))))).
lex('Et', dr(0,dr(0,s,s),dr(0,s,s)), lambda(SS,lambda(S,lambda(E,merge(drs([event(F)],[appl(appl(parallel,F),E),bool(F,=,'event?')]),merge(appl(S,E),appl(appl(SS,S),E))))))).
lex(et, dr(0,np,np), lambda(NP,lambda(P,appl(NP,lambda(X,merge(drs([variable(Y)],[bool(Y,=,'context?'),bool(X,in,Y)]),appl(P,X))))))).
lex('Et', dr(0,np,np), lambda(NP,lambda(P,appl(NP,lambda(X,merge(drs([variable(Y)],[bool(Y,=,'context?'),bool(X,in,Y)]),appl(P,X))))))).

lex(ou, dr(0,dl(0,np,np),np), lambda(NP2,lambda(NP1,lambda(P,merge(drs([variable(Z)],[bool(appl(NP1,lambda(X,drs([],[bool(X,=,Z)]))),\/,appl(NP2,lambda(Y,drs([],[bool(Y,=,Z)]))))]),appl(P,Z)))))).
...
lex(ou, dr(0,dl(0,dl(0,lit(np(_,_,_)),lit(s(Z))),dl(0,lit(np(_,_,_)),lit(s(Z)))),dl(0,lit(np(_,_,_)),lit(s(_)))),lambda(P,lambda(Q,lambda(NP,lambda(E,appl(NP,lambda(X,drs([],[bool(merge(drs([event(G)],[bool(G,=,E)]),appl(appl(Q,lambda(X1,appl(X1,X))),G)),\/,merge(drs([event(F)],[bool(F,=,E)]),appl(appl(P,lambda(X1,appl(X1,X))),F)))])))))))).
...
% 
lex(mais, dr(0,dl(0,np,np),np), lambda(NP2, lambda(NP1, lambda(P,appl(NP1,lambda(X,appl(NP2,lambda(Y,merge(drs([],[appl(appl(contrast,X),Y)]),merge(appl(P,X),appl(P,Y))))))))))).
...
lex(puis, dr(0,dl(0,dl(0,n,n),dl(0,n,n)),dl(0,n,n)), lambda(ADJ2,lambda(ADJ1,lambda(N,lambda(X,merge(appl(N,X),merge(merge(DRS1,DRS2),drs([event(E),event(F)],[drs_label(E,DRS1),drs_label(F,DRS2),bool(appl(temps,E),<,appl(temps,F))])))))))) :-
	DRS1 = appl(appl(ADJ1,N),X),
	DRS2 = appl(appl(ADJ2,N),X).
% P,Q ((e->t)->t)->s->t
% N (e->t)->t
% E s
lex(or, dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),bool(drs([],[appl(appl(violation,F),E)]),\/,drs([],[appl(appl(continuation,F),E)]))]),appl(S,E))))).
lex('Or', dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),bool(drs([],[appl(appl(violation,F),E)]),\/,drs([],[appl(appl(continuation,F),E)]))]),appl(S,E))))).
lex('OR', dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),bool(drs([],[appl(appl(violation,F),E)]),\/,drs([],[appl(appl(continuation,F),E)]))]),appl(S,E))))).
...
%lex(et, dr(0,dl(0,lit(np(_,_,_)),lit(np(_,_,_))),lit(np(_,_,_))), lambda(NP1,lambda(NP2,lambda(P,appl(NP2,lambda(X,appl(NP1,lambda(Y,merge(appl(P,X),appl(P,Y)))))))))).
...
lex(ni, dr(0,dl(1,s,s),s), lambda(S2,lambda(S1,lambda(E,drs([],[not(merge(drs([event(E1)],[bool(E1,=,E)]),appl(S1,E1))),not(merge(drs([event(E2)],[bool(E2,=,E)]),appl(S2,E2)))]))))).
lex(ni, dr(0,dl(0,s,s),s), lambda(S2,lambda(S1,lambda(E,drs([],[not(merge(drs([event(E1)],[bool(E1,=,E)]),appl(S1,E1))),not(merge(drs([event(E2)],[bool(E2,=,E)]),appl(S2,E2)))]))))).
...
lex(que, dr(0,lit(s(q)),lit(s(ppart))), lambda(X,X)).  % for weird gapping errors
...
lex(tant, dr(0,dl(1,s,s),s_q),  lambda(P, lambda(Q, lambda(_,drs([],[bool(merge(drs([event(E)],[]),appl(P,E)),->,merge(drs([event(F)],[]),appl(Q,F)))]))))).

lex(car,  dr(0,dl(0,lit(s(S)),lit(s(S))),lit(s(_))), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(explanation,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex('Car',  dr(0,dr(0,lit(s(S)),lit(s(S))),lit(s(_))), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(explanation,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex(mais, dr(0,dl(0,lit(s(S)),lit(s(S))),lit(s(_))), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(contrast,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex(et,   dr(0,dl(0,lit(s(S)),lit(s(S))),lit(s(_))), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(narration,E),F)]),merge(appl(P,E),appl(Q,F))))))).
...
% conditional rather than exclamation
lex(pourvu,   dr(0,dl(1,s,s),s_q), lambda(P, lambda(Q, lambda(_,drs([],[bool(merge(drs([event(E)],[]),appl(P,E)),->,merge(drs([event(F)],[]),appl(Q,F)))]))))).
lex('Pourvu',   dr(0,dr(0,s,s),s_q), lambda(P, lambda(Q, lambda(_,drs([],[bool(merge(drs([event(E)],[]),appl(P,E)),->,merge(drs([event(F)],[]),appl(Q,F)))]))))).

% "comme" antepose is one of "explanation", "explanation*" and "background"
lex('Comme', dr(0,dr(0,s,s),s), lambda(P,lambda(Q,lambda(F,merge(drs([event(E)],[bool(drs([],[appl(appl(explanation,E),F)]),\/,bool(drs([],[appl(appl('explanation*',E),F)]),\/,drs([],[appl(appl(background,E),F)])))]),merge(appl(P,E),appl(Q,F))))))).
lex(comme, dr(0,dr(0,s,s),s), lambda(P,lambda(Q,lambda(F,merge(drs([event(E)],[bool(drs([],[appl(appl(explanation,E),F)]),\/,bool(drs([],[appl(appl('explanation*',E),F)]),\/,drs([],[appl(appl(background,E),F)])))]),merge(appl(P,E),appl(Q,F))))))).
% "comme" postpose is "parallel"
lex(comme, dr(0,dl(1,s,s),s), lambda(P,lambda(Q,lambda(F,merge(drs([event(E)],[appl(appl(parellel,E),F)]),merge(appl(P,E),appl(Q,F))))))).
lex(plus, dr(0,dl(1,lit(s(SS)),lit(s(SS))),s_q), lambda(P,lambda(Q,lambda(F,merge(drs([event(E),event(F)],[appl(appl(plus_que,E),F)]),merge(appl(P,E),appl(Q,F))))))).

% not sure about the possibility of "explanation*" for sentence-initial "parce que"
lex('Parce', dr(0,dr(0,lit(s(SS)),lit(s(SS))),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[bool(drs([],[appl(appl(explanation,F),E)]),\/,drs([],[appl(appl('explanation*',F),E)]))]),merge(appl(P,E),appl(Q,F))))))).
lex(parce, dr(0,dr(0,lit(s(SS)),lit(s(SS))),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[bool(drs([],[appl(appl(explanation,F),E)]),\/,drs([],[appl(appl('explanation*',F),E)]))]),merge(appl(P,E),appl(Q,F))))))). 
lex(parce, dr(0,dl(1,lit(s(SS)),lit(s(SS))),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[bool(drs([],[appl(appl(explanation,F),E)]),\/,drs([],[appl(appl('explanation*',F),E)]))]),merge(appl(P,E),appl(Q,F))))))). 
lex(parce, dr(0,s,s_q), lambda(Q,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),appl(appl(explanation,F),E)]),appl(Q,E))))).

lex(donc, dl(1,lit(s(SS)),lit(s(SS))), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),bool(drs([],[appl(appl(result,E),F)]),\/,drs([],[appl(appl('result*',E),F)]))]),appl(S,E))))).
lex(donc, dr(0,lit(s(SS)),lit(s(SS))), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),bool(drs([],[appl(appl(result,E),F)]),\/,drs([],[appl(appl('result*',E),F)]))]),appl(S,E))))).
lex('Donc', dr(0,lit(s(SS)),lit(s(SS))), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),bool(drs([],[appl(appl(result,E),F)]),\/,drs([],[appl(appl('result*',E),F)]))]),appl(S,E))))).

lex(pourtant, dl(1,lit(s(SS)),lit(s(SS))), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),bool(drs([],[appl(appl(violation,E),F)]),\/,drs([],[appl(appl(concession,E),F)]))]),appl(S,E))))).
lex(pourtant, dr(0,lit(s(SS)),lit(s(SS))), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),bool(drs([],[appl(appl(violation,E),F)]),\/,drs([],[appl(appl(concession,E),F)]))]),appl(S,E))))).
lex('Pourtant', dr(0,lit(s(SS)),lit(s(SS))), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),bool(drs([],[appl(appl(violation,E),F)]),\/,drs([],[appl(appl(concession,E),F)]))]),appl(S,E))))).

lex('Pour', dr(0,dr(0,lit(s(SS)),lit(s(SS))),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(goal,E),F)]),merge(appl(P,E),appl(Q,F))))))).
lex(pour, dr(0,dr(0,lit(s(SS)),lit(s(SS))),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(goal,E),F)]),merge(appl(P,E),appl(Q,F))))))).
lex(pour, dr(0,dl(1,lit(s(SS)),lit(s(SS))),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(goal,E),F)]),merge(appl(P,E),appl(Q,F))))))).

lex('Afin', dr(0,dr(0,lit(s(SS)),lit(s(SS))),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(goal,E),F)]),merge(appl(P,E),appl(Q,F))))))).
lex(afin, dr(0,dr(0,lit(s(SS)),lit(s(SS))),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(goal,E),F)]),merge(appl(P,E),appl(Q,F))))))).
lex(afin, dr(0,dl(1,lit(s(SS)),lit(s(SS))),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(goal,E),F)]),merge(appl(P,E),appl(Q,F))))))).

lex(lorsque, dr(0,dr(0,s,s),s), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[bool(bool(drs([],[appl(appl(background,E),F)]),\/,drs([],[appl(appl(background,F),E)])),\/,drs([],[appl(appl(explanation,E),F)]))]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,E),overlaps,appl(temps,F))]))))))).
lex(lorsque, dr(0,dl(1,s,s),s), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[bool(bool(drs([],[appl(appl(background,E),F)]),\/,drs([],[appl(appl(background,F),E)])),\/,drs([],[appl(appl(explanation,E),F)]))]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,E),overlaps,appl(temps,F))]))))))).
lex('lorsqu\'', dr(0,dr(0,s,s),s), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[bool(bool(drs([],[appl(appl(background,E),F)]),\/,drs([],[appl(appl(background,F),E)])),\/,drs([],[appl(appl(explanation,E),F)]))]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,E),overlaps,appl(temps,F))]))))))).
lex('lorsqu\'', dr(0,dl(1,s,s),s), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[bool(bool(drs([],[appl(appl(background,E),F)]),\/,drs([],[appl(appl(background,F),E)])),\/,drs([],[appl(appl(explanation,E),F)]))]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,E),overlaps,appl(temps,F))]))))))).
lex('Lorsque', dr(0,dr(0,s,s),s), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[bool(bool(drs([],[appl(appl(background,E),F)]),\/,drs([],[appl(appl(background,F),E)])),\/,drs([],[appl(appl(explanation,E),F)]))]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,E),overlaps,appl(temps,F))]))))))).
lex('Lorsqu\'', dr(0,dr(0,s,s),s), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[bool(bool(drs([],[appl(appl(background,E),F)]),\/,drs([],[appl(appl(background,F),E)])),\/,drs([],[appl(appl(explanation,E),F)]))]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,E),overlaps,appl(temps,F))]))))))).
...
lex(depuis, dr(0,dr(0,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,F),starts,appl(temps,E))]))))))).
lex(depuis, dr(0,dl(1,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,F),starts,appl(temps,E))]))))))).
lex('Depuis', dr(0,dr(0,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,F),starts,appl(temps,E))]))))))).
lex('Depuis', dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),bool(appl(temps,F),starts,appl(temps,E))]),appl(S,E))))).

lex(ensuite, dl(1,s,s), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),appl(appl(narration,E),F)]),appl(S,E))))).
lex(ensuite, dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),appl(appl(narration,E),F)]),appl(S,E))))).
lex('Ensuite', dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),appl(appl(narration,E),F)]),appl(S,E))))).
...
lex(avant, dr(0,dr(0,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,E),<,appl(temps,F))]))))))).
lex(avant, dr(0,dl(1,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,E),<,appl(temps,F))]))))))).
lex('Avant', dr(0,dr(0,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,E),<,appl(temps,F))]))))))).

lex('Avant', dr(0,dr(0,s,s),np), lambda(NP,lambda(S,lambda(E,merge(appl(NP,lambda(X,drs([],[bool(appl(temps,X),>,appl(temps,E))]))),appl(S,E)))))).
lex(avant, dr(0,dl(1,s,s),np), lambda(NP,lambda(S,lambda(E,merge(appl(NP,lambda(X,drs([],[bool(appl(temps,X),>,appl(temps,E))]))),appl(S,E)))))).
lex(avant, dr(0,dr(0,s,s),np), lambda(NP,lambda(S,lambda(E,merge(appl(NP,lambda(X,drs([],[bool(appl(temps,X),>,appl(temps,E))]))),appl(S,E)))))).
...
lex(dès, dr(0,dr(0,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,F),abuts,appl(temps,E))]))))))).
lex(dès, dr(0,dl(1,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,F),abuts,appl(temps,E))]))))))).
lex('Dès', dr(0,dr(0,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,F),abuts,appl(temps,E))]))))))).

lex(aussitôt, dr(0,dr(0,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,F),abuts,appl(temps,E))]))))))).
lex(aussitôt, dr(0,dl(1,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,F),abuts,appl(temps,E))]))))))).
lex('Aussitôt', dr(0,dr(0,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,F),abuts,appl(temps,E))]))))))).

lex(sitôt, dr(0,dr(0,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,F),abuts,appl(temps,E))]))))))).
lex(sitôt, dr(0,dl(1,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,F),abuts,appl(temps,E))]))))))).
lex('Sitôt', dr(0,dr(0,s,s),s_q), lambda(S1,lambda(S2,lambda(E,merge(merge(drs([event(F)],[]),appl(S1,F)),merge(appl(S2,E),drs([],[bool(appl(temps,F),abuts,appl(temps,E))]))))))).

lex(puisque, dr(0,dl(0,lit(s(SS)),lit(s(SS))),lit(s(_))), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(explanation,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex(puisque, dr(0,dl(1,lit(s(SS)),lit(s(SS))),lit(s(_))), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(explanation,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex('Puisque', dr(0,dr(0,lit(s(SS)),lit(s(SS))),lit(s(_))), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(explanation,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex('puisqu\'', dr(0,dl(0,lit(s(SS)),lit(s(SS))),lit(s(_))), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(explanation,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex('puisqu\'', dr(0,dl(1,lit(s(SS)),lit(s(SS))),lit(s(_))), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(explanation,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex('Puisqu\'', dr(0,dr(0,lit(s(SS)),lit(s(SS))),lit(s(_))), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(explanation,F),E)]),merge(appl(P,E),appl(Q,F))))))).

lex(bien, dr(0,dr(0,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(concession,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex(bien, dr(0,dl(1,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(concession,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex('Bien', dr(0,dr(0,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(concession,F),E)]),merge(appl(P,E),appl(Q,F))))))).

lex(cependant, dr(0,dr(0,s,s),s), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(opposition,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex(cependant, dr(0,dl(1,s,s),s), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(opposition,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex('Cependant', dr(0,dr(0,s,s),s), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(opposition,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex('Cependant', dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[appl(appl(opposition,F),E),bool(F,=,'event?')]),appl(S,E))))).

lex(cependant, dr(0,dr(0,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(concession,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex(cependant, dr(0,dl(1,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(concession,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex('Cependant', dr(0,dr(0,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(concession,F),E)]),merge(appl(P,E),appl(Q,F))))))).

lex(comme, dr(0,dr(0,s,s),s), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(parallel,E),F)]),merge(appl(P,E),appl(Q,F))))))).
lex(comme, dr(0,dl(1,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(parallel,E),F)]),merge(appl(P,E),appl(Q,F))))))).
lex('Comme', dr(0,dr(0,s,s),s), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(parallel,E),F)]),merge(appl(P,E),appl(Q,F))))))).
lex('Comme', dr(0,dr(0,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(parallel,E),F)]),merge(appl(P,E),appl(Q,F))))))).

lex('Néanmoins', dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[appl(appl(opposition,F),E),bool(F,=,'event?')]),appl(S,E))))).
lex(néanmoins, dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[appl(appl(opposition,F),E),bool(F,=,'event?')]),appl(S,E))))).
lex(néanmoins, dl(1,s,s), lambda(S,lambda(E,merge(drs([event(F)],[appl(appl(opposition,F),E),bool(F,=,'event?')]),appl(S,E))))).

lex(quoique, dr(0,dr(0,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(concession,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex(quoique, dr(0,dl(1,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(concession,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex('Quoique', dr(0,dr(0,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(concession,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex('Quoique', dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[appl(appl(concession,F),E),bool(F,=,'event?')]),appl(S,E))))).
lex('quoiqu\'', dr(0,dr(0,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(concession,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex('quoiqu\'', dr(0,dl(1,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(concession,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex('Quoiqu\'', dr(0,dr(0,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[appl(appl(concession,F),E)]),merge(appl(P,E),appl(Q,F))))))).
lex('Quoiqu\'', dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[appl(appl(concession,F),E),bool(F,=,'event?')]),appl(S,E))))).

% "tandis que" indicates either a contrast or background (and temporal overlap)

lex(tandis, dr(0,dr(0,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[bool(drs([],[appl(appl(contrast,F),E)]),\/,drs([],[appl(appl(background,F),E)]))]),merge(appl(P,E),appl(Q,F))))))).
lex(tandis, dr(0,dl(1,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[bool(drs([],[appl(appl(contrast,F),E)]),\/,drs([],[appl(appl(background,F),E)]))]),merge(appl(P,E),appl(Q,F))))))).
lex('Tandis', dr(0,dr(0,s,s),s_q), lambda(P,lambda(Q,lambda(E,merge(drs([event(F)],[bool(drs([],[appl(appl(contrast,F),E)]),\/,drs([],[appl(appl(background,F),E)]))]),merge(appl(P,E),appl(Q,F))))))).

lex('Bref', dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[appl(appl(summary,E),F),bool(F,=,'event?')]),appl(S,E))))).
lex('Néanmoins', dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[appl(appl(summary,E),F),bool(F,=,'event?')]),appl(S,E))))).
lex('néanmoins', dl(1,s,s), lambda(S,lambda(E,merge(drs([event(F)],[appl(appl(summary,E),F),bool(F,=,'event?')]),appl(S,E))))).
lex('Autrement', dr(0,s,s), lambda(S,lambda(E,merge(drs([event(F)],[bool(F,=,'event?'),bool(drs([],[appl(appl(alternation,E),F)]),\/,bool(drs([],[appl(appl(continuation,E),F)]),\/,drs([],[appl(appl(violation,E),F)])))]),appl(S,E))))).
...
% appositive relative clauses are treated as presuppositions (this is an oversimplification, unlike presuppositions, they cannot be cancelled though they do project)
...
lex(y, dr(0,dl(0,cl_r,dl(0,lit(np(_,_,_)),lit(s(Z)))),dl(0,cl_r,dl(0,lit(np(_,_,_)),lit(s(Z))))), lambda(P,lambda(Cl,lambda(Q,lambda(E,merge(drs([],[bool(X,=,'lieu?'),appl(appl(à,X),E)]),appl(appl(appl(P,Cl),Q),E))))))).
...
lex(en, dr(0,dl(0,np,s),dr(0,dl(0,np,s),dia(1,box(1,np)))), lambda(TV,lambda(NP,lambda(E,appl(NP,lambda(Z,merge(drs([variable(Y),variable(X)],[appl(appl(de,Y),X),bool(Y,=,'?')]),appl(appl(appl(TV,lambda(Q,appl(Q,X))),lambda(Q1,appl(Q1,Z))),E)))))))).
...
% only sentence-initial "ainsi" can be a discourse connective
lex('Ainsi', dr(0,s,s), lambda(S,lambda(E,merge(drs([],[bool(F,=,'event?'),appl(appl(result,E),F)]),appl(S,E))))).
lex(ainsi, dr(0,s,s), lambda(S,lambda(E,merge(drs([],[bool(F,=,'event?'),appl(appl(result,E),F)]),appl(S,E))))).

lex('Alors', dr(0,s,s), lambda(S,lambda(E,merge(drs([],[bool(F,=,'event?'),bool(bool(drs([],[appl(appl(result,E),F)]),\/,drs([],[appl(appl('result*',E),F)])),\/,drs([],[appl(appl(narration,E),F)]))]),appl(S,E))))).
lex(alors, dr(0,s,s), lambda(S,lambda(E,merge(drs([],[bool(F,=,'event?'),bool(bool(drs([],[appl(appl(result,E),F)]),\/,drs([],[appl(appl('result*',E),F)])),\/,drs([],[appl(appl(narration,E),F)]))]),appl(S,E))))).
...
lex('Si', dr(0,lit(s(whq)),lit(s(main))), lambda(S, lambda(E, drs([],[appl('si?',E),drs_label(E,merge(drs([event(F)],[]),appl(S,F)))])))).
lex('si', dr(0,lit(s(whq)),dl(0,np,lit(s(inf(_))))), lambda(INF, lambda(E, drs([],[appl('si?',E),drs_label(E,merge(drs([event(F),variable(Y)],[appl(generic,Y)]),appl(appl(INF,lambda(P,appl(P,Y))),F)))])))).
lex(si, dr(0,lit(s(whq)),lit(s(main))), lambda(S, lambda(E, drs([],[appl('si?',E),drs_label(E,merge(drs([event(F)],[]),appl(S,F)))])))).
lex(si, dr(0,lit(s(whq)),dl(0,np,lit(s(inf(_))))), lambda(INF, lambda(E, drs([],[appl('si?',E),drs_label(E,merge(drs([event(F),variable(Y)],[appl(generic,Y)]),appl(appl(INF,lambda(P,appl(P,Y))),F)))])))).
lex('S\'', dr(0,lit(s(whq)),lit(s(main))), lambda(S, lambda(E, drs([],[appl('si?',E),drs_label(E,merge(drs([event(F)],[]),appl(S,F)))])))).
lex('S\'', dr(0,lit(s(whq)),dl(0,np,lit(s(inf(_))))), lambda(INF, lambda(E, drs([],[appl('si?',E),drs_label(E,merge(drs([event(F),variable(Y)],[appl(generic,Y)]),appl(appl(INF,lambda(P,appl(P,Y))),F)))])))).
lex('s\'', dr(0,lit(s(whq)),lit(s(main))), lambda(S, lambda(E, drs([],[appl('si?',E),drs_label(E,merge(drs([event(F)],[]),appl(S,F)))])))).
lex('s\'', dr(0,lit(s(whq)),dl(0,np,lit(s(inf(_))))), lambda(INF, lambda(E, drs([],[appl('si?',E),drs_label(E,merge(drs([event(F),variable(Y)],[appl(generic,Y)]),appl(appl(INF,lambda(P,appl(P,Y))),F)))])))).
...
lex('(', dr(0,dl(0,lit(np(_,_,_)),lit(np(_,_,_))),dl(_,lit(np(_,_,_)),lit(s(_)))), lambda(VP,lambda(NP,lambda(P,appl(NP,lambda(X,merge(appl(P,X),merge(drs([event(E)],[appl(appl(background,X),E)]),appl(appl(VP,NP),E))))))))).
